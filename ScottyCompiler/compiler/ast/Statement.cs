namespace ScottyCompiler.compiler.ast {
  ...
  public class SequentialStatement : Statement { // statement ; statement
  ...
  public class VariableDeclarationStatement : Statement { // var-name = expression ;
  ...
  public class VariableAssignStatement : Statement { // var-name = expression ;
